...
public class Navbar {
    ...
    public static void loadNavbar(){
        ...
        navbar.addEnd(new NavbarIcon("https://github.com/SuperMartijn642","/common/icons/githubicon.png"));
        navbar.addEnd(new NavbarIcon("https://www.curseforge.com/members/supermartijn642","/common/icons/curseicon.png"));
